...
const NMWaterLevel: React.FC<Props> = ({ data, frequency }) => {
  const n = useRef(9);
  ...
  useEffect(() => {
    const interval = setInterval(() => {
      ...
      _data.splice(0, 1);
      _data.push(data[n.current].nm_water_level);
        ...
        datasets: [
          {
            ...
            data: toShow?.map((el) => el.nm_water_level),
